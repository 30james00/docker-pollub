...
docker run -itd --name d2 --network-alias apa1 --net bridge1 -p 10.0.10.0:8080:8080 -p 10.0.11.0:8081:8081 httpd
...
docker inspect d1 | jq
docker inspect d2 | jq
docker inspect s1 | jq